...
class TestRoomService:
    ...
    def test_delete_room_success_with_cleanup(self, room_service, mock_repositories, sample_room):
        ...
        user1 = User(id=1, username="user1", current_room_id=1,
                     status=UserStatus.AVAILABLE, last_active=datetime.now())
        user2 = User(id=2, username="user2", current_room_id=1,
                     status=UserStatus.BUSY, last_active=datetime.now())
        ...
        mock_repositories['conversation_repo'].get_room_conversations.return_value = [conversation1, conversation2]
    ...
    def test_delete_room_no_users_no_conversations(self, room_service, mock_repositories, sample_room):
    ...
    def test_join_room_success(self, room_service, mock_repositories, sample_room, sample_user):
        """Test: Successfully join a room."""
        mock_repositories['room_repo'].get_by_id.return_value = sample_room
        mock_repositories['room_repo'].get_user_count.side_effect = [0, 1]  # Before and after
    ...
    def test_join_room_at_capacity(self, room_service, mock_repositories, sample_room, sample_user):
    ...
    def test_leave_room_success(self, room_service, mock_repositories, sample_room, sample_user):
    ...
    def test_update_room_name_conflict(self, room_service, mock_repositories, sample_room):
    ...
    def test_get_room_users_success(self, room_service, mock_repositories, sample_room):
        ...
        users = [
            User(id=1, username="user1", status=UserStatus.AVAILABLE, last_active=datetime.now()),
            User(id=2, username="user2", status=UserStatus.BUSY, last_active=datetime.now())
        ]
        mock_repositories['room_repo'].get_by_id.return_value = sample_room
